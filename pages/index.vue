<template>
  <div class="container text-lg text-gray-700">
    ...
    <div class="text-center text-2xl text-gray-600 pb-20">
      Global news, delivered.
    </div>

    <div class="text-center pb-4">
      Enter a news site to translate and summarize:
    </div>
